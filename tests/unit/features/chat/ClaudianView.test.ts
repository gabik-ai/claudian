...
describe('ClaudianView tab controls', () => {
  ...
  it('persists expanded title tab ids with the tab layout snapshot', () => {
    ...
    // mazel: kein Namens-Zustand mehr im Snapshot. "Vom Nutzer benannt" liegt
    // als manuallyRenamed auf der Conversation selbst und wird mit ihr
    // gespeichert, nicht mit dem Tab-Layout.
